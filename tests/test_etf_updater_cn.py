...
@patch("apis.tushare.etf_cn.get_client")
def test_fetch_etf_daily_hfq_merges_close_and_adj(mock_get_client):
    ...
    from apis.tushare.etf_cn import fetch_etf_daily_hfq
...
@patch("apis.tushare.etf_cn.CN_SECTOR_ETFS", {"512800.SH": {"name": "银行ETF", "gics": "Financials"}})
@patch("apis.tushare.etf_cn.query")
@patch("apis.tushare.etf_cn.execute")
@patch("apis.tushare.etf_cn.fetch_etf_daily_hfq")
...
@patch("apis.tushare.etf_cn.CN_SECTOR_ETFS", {
