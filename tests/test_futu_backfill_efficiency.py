...
from apis.futu.backfill_efficiency import backfill_efficiency
...
from apis.futu.backfill_efficiency import backfill_all as eff_all


def test_efficiency_backfill_all_uses_ticker_stream():
    with patch("apis.futu.backfill_efficiency.get_client"), \
         patch("apis.futu.backfill_efficiency.ticker_stream",
